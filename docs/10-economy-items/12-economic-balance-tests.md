...
```json
{
  ...
  "cases": [
    ...
    {"test_id": "TEST-ECON-031", "fixture_id": "econ.pricing.v1", "case_id": "quote_hash_expiry_and_limit", "runner": "economy.pricing.contract", "command_sequence": ["canonicalize_and_hash(golden_quote)", "tamper(quantity=3,keep_old_hash)", "advance(11)", "set_maximum_below_quote"], "oracle": "canonical_preimage_sha256 == '18aa059a94c920a5f03c3f0ac5c489941b643143be6f4c8a6e27c59f52b5fee2' && errors == ['quote_input_changed','quote_expired','maximum_price_exceeded']"},
