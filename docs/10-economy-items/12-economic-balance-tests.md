...
```json
{
  ...
  "cases": [
    ...
    {"test_id": "TEST-ECON-029", "fixture_id": "econ.pricing.v1", "case_id": "q1000_golden", "runner": "economy.pricing.golden", "command_sequence": ["price(base=100,multipliers=[1200,1100,1000,1250,900])"], "oracle": "unit_price_copper_feather == 149"},
    {"test_id": "TEST-ECON-030", "fixture_id": "econ.pricing.v1", "case_id": "price_bounds", "runner": "economy.pricing.property", "command_sequence": ["generate_valid_multiplier_edges", "generate_out_of_range_multiplier"], "oracle": "all_valid_prices_between_floor_ceiling && invalid_error == 'price_multiplier_out_of_range'"},
